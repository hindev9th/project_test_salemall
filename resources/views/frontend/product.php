    ...
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="<?php asset('images/products/' . $product->getImage()); ?>" alt="Image">
                        </div>
                </div>
        ...
        <div class="col-lg-7 pb-5">
            ...
            <div class="price d-flex flex-wrap">
                <?php if (auth()): ?>
                    <h3 class="font-weight-semi-bold mb-4"><?= number_format($product->getPrice()) ?>đ</h3>
                <?php else: ?>
                    <h3 class="font-weight-semi-bold mb-4">Liên hệ</h3>
                <?php endif; ?>
            </div>
